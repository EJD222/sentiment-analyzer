            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        <x-nav-link :href="route('sentiment-analysis')" :active="request()->routeIs('sentiment-analysis')" wire:navigate>
                            {{ __('Sentiment Analysis') }}
                        </x-nav-link>
                        <x-nav-link :href="route('history-index')" :active="request()->routeIs('history-index')" wire:navigate>
